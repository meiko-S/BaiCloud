...
if ($action=="del") {
checkadminisdo("label");
$f="../template/".siteskin."/label/ppshow/".nostr(trim($_POST["title"])).".txt";
	if (file_exists($f)){
	unlink($f);
	}else{
...
if (file_exists("../template/".siteskin."/label/ppshow")==false){
echo '文件不存在';
}else{			
$dir = opendir("../template/".siteskin."/label/ppshow");

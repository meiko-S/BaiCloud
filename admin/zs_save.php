...
$smallclassid="";
    ...
    //$smallclassid=$smallclassid.('"'.$_POST['smallclassid'][$i].'"'.',');//字符串类型的写法
...
$isok=query("update zzcms_main set bigclassid='$bigclassid',smallclassid='$smallclassid',smallclassids='$smallclassid',shuxing='$shuxing',szm='$szm',prouse='$prouse',proname='$cpname',sm='$sm',img='$img',flv='$flv',zc='$zc',yq='$yq',shuxing_value='$shuxing_value',title='$title',keywords='$keywords',description='$discription',sendtime='$sendtime',tag='$tag' where id='$cpid'");
if ($editor<>$oldeditor) {

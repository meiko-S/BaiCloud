...
$f="../template/".siteskin."/label/wangkanshow/".$title.".txt";
...
<body>
<div class="admintitle">网刊内容标签</div>
...
if (file_exists("../template/".siteskin."/label/wangkanshow")==false){
echo '文件不存在';
}else{		
$dir = opendir("../template/".siteskin."/label/wangkanshow");
...
//读取现有标签中的内容
if ($labelname!=''){
$fp="../template/".siteskin."/label/wangkanshow/".$labelname;
$f=fopen($fp,"r");

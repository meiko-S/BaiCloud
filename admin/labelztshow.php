...
$f="../template/".siteskin."/label/specialshow/".$title.".txt";
...
<body>
<div class="admintitle">专题内容标签</div>
...
if (file_exists("../template/".siteskin."/label/specialshow")==false){
echo '文件不存在';
}else{		
$dir = opendir("../template/".siteskin."/label/specialshow");
...
//读取现有标签中的内容
if ($labelname!=''){
$fp="../template/".siteskin."/label/specialshow/".$labelname;
$f=fopen($fp,"r");
